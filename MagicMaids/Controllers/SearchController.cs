	...
	public class SearchController : BaseController
	{
        ...
        private void SetCleanerMatchProperties(ref List<CleanerMatchResultVM> CleanerMatchResultList, SearchVM searchCriteria)
        {
            ...
            {               
                ...
                CleanerMatchResult.SelectedServiceDate = (searchCriteria.WeeklyJob || searchCriteria.FortnightlyJob) ? DateTimeWrapper.FindNextDateForDay(CleanerMatchResult.SelectedRosterDay) : searchCriteria.ServiceDateUser;
